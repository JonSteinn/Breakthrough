 ...
 * 
 * <p> client.NanoHTTPD version 1.01,
...
public class NanoHTTPD
{
	...
	public NanoHTTPD( int port) throws IOException
	{
		...
		server_thread.start();
		System.out.println("client.NanoHTTPD is listening on port "+port);
	}
	...
	{
		System.out.println( "client.NanoHTTPD 1.0 (c) 2001 Jarno Elonen\n" +
